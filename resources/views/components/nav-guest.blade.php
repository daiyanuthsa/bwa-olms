    ...
    <div class="flex w-[1280px] px-[75px] py-5 items-center justify-between mx-auto">
        <div class="flex items-center gap-[50px]">
            ...
            <ul class="flex items-center gap-10">
                <li
                    class="hover:font-semibold transition-all duration-300 {{ request()->routeIs('front.index') ? 'font-semibold' : '' }} ">
                    <a href="{{ route('front.index') }}">Home</a>
                </li>
                <li class="hover:font-semibold transition-all duration-300 {{ request()->routeIs('front.pricing') ? 'font-semibold' : '' }}">
