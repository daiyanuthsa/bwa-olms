                    ...
                    <div class="flex items-center justify-between rounded-[20px] border border-obito-grey p-[14px]">
                        <div class="profile flex items-center gap-[14px]">
                            <div class="flex justify-center items-center overflow-hidden size-[50px] rounded-full">
                                <img src="{{ Storage::url($user->photo) }}" alt="{{ $user->name }}" class="size-full object-cover" />
                            </div>
                ...
                <section id="transaction-details" class="flex flex-col gap-[12px]">
                    ...
                    <div class="flex flex-col gap-[12px]">
                        <div class="flex items-center justify-between">
                            ...
                            <strong class="font-semibold">Rp {{ number_format($total_sub_amount, 0,'','.') }}</strong>
                        </div>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2">
                                <img src="{{asset('assets/images/icons/note.svg')}}" alt="icon" class="size-5 shrink-0" />
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <strong class="font-semibold">{{ date_format(new DateTime($started_at), 'd M Y') }}</strong>
                        </div>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2">
                                <img src="{{asset('assets/images/icons/note.svg')}}" alt="icon" class="size-5 shrink-0" />
                            ...
                            <strong class="font-semibold">{{ date_format(new DateTime($ended_at), 'd M Y') }}</strong>
                        </div>
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2">
                                <img src="{{asset('assets/images/icons/note.svg')}}" alt="icon" class="size-5 shrink-0" />
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <strong class="font-bold text-[22px] leading-[33px] text-obito-green">Rp {{ number_format($total_grand_amount, 0,'','.') }}</strong>
                        </div>
                    </div>
                </section>
...
@push('after-scripts')
    ...
    payButton.addEventListener('click', function (e) {
      ...
      .then(data => {
        if (data.snap_token) {
          // Use snap token to open the payment page
